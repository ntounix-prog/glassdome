"""
Kali Linux Installer Agent
Autonomous agent for creating base Kali Linux installation images

PLATFORM-AGNOSTIC: Works with any platform (Proxmox, AWS, Azure, etc.)
This agent knows HOW to configure Kali Linux, not WHERE to deploy it.
"""
import logging
